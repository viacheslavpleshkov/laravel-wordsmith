    ...
    <div class="row justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="col-lg-3">
            <div class="pull-right">
                <a class="btn btn-original" href="{{ route('tags.create') }}">{{ __('admin.create-skills') }}</a>
            </div>
        </div>
    </div>
        ...
        <table id="datatable" class="table table-striped table-bordered" style="width:100%">
            ...
            @foreach($main as $item)
                <tr>
                    ...
                    <td scope="row">
                        <a href="{{ route('tags.show',$item->id) }}"><i class="far fa-eye"></i></a>
                        <a href="{{ route('tags.edit',$item->id) }}"><i class="fas fa-edit"></i></a>
