		...
		<ul class="navbar-nav mr-auto">
			...
			@if(in_array(Auth::user()->role->name, ['Moderator','Admin']))
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item {{ Request::is('*articles*') ? 'active' : '' }}" href="{{ route('articles.index') }}"><i class="fas fa-newspaper"></i> {{ __('admin.nav-articles') }}</a>
						...
						<a class="dropdown-item {{ Request::is('*comments*') ? 'active' : '' }}" href="{{ route('comments.index') }}"><i class="fas fa-comments"></i> {{ __('admin.nav-comments') }}</a>
					</div>
				</li>
			...
			@if(in_array(Auth::user()->role->name, ['Admin']))
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item {{ Request::is('*settings*') ? 'active' : '' }}" href="{{ route('settings.index') }}"><i class="fas fa-wrench"></i>{{ __('admin.nav-settings') }}</a>
						<a class="dropdown-item {{ Request::is('*seo*') ? 'active' : '' }}" href="{{ route('seo.index') }}"><i class="fas fa-chart-line"></i> {{ __('admin.nav-seo') }}</a>
					</div>
				</li>
			@endif
		</ul>
