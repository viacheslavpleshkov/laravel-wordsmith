...
/* @var $news array|\frontend\models\News|null|\yii\db\ActiveRecord */
/* @var $comments array|\frontend\models\Comment[]|\yii\db\ActiveRecord[] */

$this->title = $news->title;

?>
    <p class="lead">Автор: <a href="#"><?=$news->user->username ?></a></p>
    <hr>
    ...
    <p><?=$news->content ?></p>
    <hr>
     <p>Категорія: <a href="<?=Url::to(['category/view', 'id' => $news->category->id]); ?>"><?=$news->category->title; ?></a></p>
    <hr>
...
<?php else:?>
    <div class="alert alert-danger text-center" role="alert">
        <p>Вибачте але ви не можете залити коментар тому що ви не зарегестровані, аба не вішли на сайт</p>
    </div>
<?php endif;?>
